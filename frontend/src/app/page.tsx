    ...
    <div className="relative min-h-screen overflow-hidden bg-black text-white selection:bg-blue-500/30 selection:text-blue-200">
      ...
      <header className="mx-auto max-w-7xl px-6 h-20 flex items-center justify-between border-b border-zinc-900/50 backdrop-blur-md sticky top-0 z-50">
        <Link href="/" className="flex items-center gap-3">
          <img src="/logo.png" alt="AttendSync Logo" className="w-9 h-9 rounded-xl object-contain shadow-lg shadow-blue-500/10" />
      ...
      {/* Hero Section */}
      <main className="mx-auto max-w-7xl px-6 pt-16 pb-32 flex flex-col items-center text-center relative">
        <motion.div
        ...
        >
          ...
          <motion.div variants={itemVariants} className="mb-2">
            <div className="relative group p-1.5 rounded-2xl bg-gradient-to-b from-white/10 to-white/5 border border-white/10 backdrop-blur-xl shadow-2xl shadow-blue-500/20">
              <img src="/logo.png" alt="AttendSync Logo" className="w-24 h-24 sm:w-28 sm:h-28 rounded-xl object-contain transition-transform duration-300 group-hover:scale-105" />
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-blue-500/30 bg-blue-500/10 text-xs text-blue-400 font-semibold"
          >
